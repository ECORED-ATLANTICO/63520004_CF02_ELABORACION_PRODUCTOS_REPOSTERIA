  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 1
      h1 Terminología técnica en repostería

    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-right")
      .col-lg-12
        .bloque-texto-g.bloque-texto-g.bg-color-1.p-3.p-sm-4.p-md-5.mb-5
          .bloque-texto-g__img(
      ...
      .col-lg-12
        p.mb-0 A continuación, se presentan los términos fundamentales que todo profesional de la repostería debe conocer y aplicar en su práctica diaria, presentados en formato de tabla para facilitar su consulta:

    .row.justify-content-center.align-items-center(data-aos="fade-right")
      .col-lg-12
        .titulo-sexto.color-acento-contenido.mb-4
          h5.text-bold Tabla 1.
          span Términos de repostería
        .tabla-a.color-acento-contenido.mb-0
          table
            ...
            tbody
              ...
              tr
                td Blanquear.
                td Batir huevos o yemas con azúcar hasta obtener una mezcla espumosa, de color claro y que aumenta significativamente su volumen. Este proceso incorpora aire y disuelve parcialmente el azúcar, siendo fundamental en la elaboración de bizcochos y algunas cremas.
              tr
                td Caramelizar.
                td Calentar azúcar hasta que se funde y adquiere color ámbar, desarrollando sabores complejos y característicos. El proceso debe controlarse cuidadosamente, pues el azúcar puede pasar rápidamente de caramelizada a quemada.
              tr
                td Cremar.
              ...
              tr
                td Macerar.
                td Dejar reposar frutas en azúcar, licor, almíbar o especias para que absorban sabores, se ablanden y liberen sus jugos. Proceso esencial en preparaciones como ensaladas de frutas, tartas y postres con frutas marinadas.
              tr
                td Mermar.
